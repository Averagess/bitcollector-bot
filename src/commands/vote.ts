...
const voteCommand = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    const voteEmbed = new EmbedBuilder()
      ...
      .setDescription("By voting, you help me grow and in return i give you an crate you can open!\nIf you vote on top.gg on an weekend, you get 2 crates. On other sites, you get 1 crate.\nYou can vote every 12 hours on all sites.")
      .addFields(
        { name: "Top.gg", value: "[Click here](https://top.gg/bot/1063172109481824286/vote)", inline: true },
        { name: "Discords.com", value: "[Click here](https://discords.com/bots/bot/1063172109481824286/vote)", inline: true },
        { name: "Discordbotlist.com", value: "[Click here](https://discordbotlist.com/bots/bit-collector/upvote)", inline: true }
      )
